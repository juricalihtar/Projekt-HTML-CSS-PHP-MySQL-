...
<html>
	<head>
		...
		<meta itemprop="name" content="Become a PROGramer">
		<meta itemprop="description" content="Some description">
		<meta itemprop="image" content="Your URL"> 
		
		<!-- Open Graph data -->
		<meta property="og:title" content="Become a PROGramer">
		...
		<!-- Twitter Card data -->
		<meta name="twitter:title" content="Become a PROGramer">
		<meta name="twitter:description" content="Some description">
		
        <meta name="author" content="jlihta1@vvg.hr">
		<!-- favicon meta -->
...
<body>
	...
	<footer>
		<p>Copyright &copy; ' . date("Y") . ' Jurica Lihtar</p>
	</footer>
</body>
</html>';
?>